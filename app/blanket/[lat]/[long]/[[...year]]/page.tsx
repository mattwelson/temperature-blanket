...
export default async function BlanketPage({params: {lat,long, year}}: {params: {
    lat: string,
    long: string,
    year?: string
}}) {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center relative">
      <Blanket temperatures={temps.daily.temperature_2m_max} />
      <SettingsDrawer active={{lat: parseFloat(lat), long: parseFloat(long)}} />
    </main>
  );
}
